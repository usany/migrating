    ...
    <div className="flex justify-center">
      ...
      <Card>
        <CardActionArea>
          ...
          >
            <div className="p-5">
              <div className="flex justify-center">팔로워</div>
              <div className="flex justify-center">{myFollowerNumber}명</div>
            </div>
          </Link>
        </CardActionArea>
      </Card>
      <Card>
        <CardActionArea>
          ...
          >
            <div className="p-5">
              <div className="flex justify-center">팔로잉</div>
              <div className="flex justify-center">{myFollowingNumber}명</div>
            </div>
          </Link>
        </CardActionArea>
      </Card>
